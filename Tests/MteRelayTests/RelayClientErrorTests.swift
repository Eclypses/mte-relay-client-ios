...
final class RelayClientErrorTests: XCTestCase {
    ...
    func testFromUpdateRequestErrorMapsToRequestPreparationFailed() {
        let converted = RelayClientError.from(MteRelayError.updateRequestError)
    ...
    func testFromMteEncodeErrorMapsToEncodingFailed() {
        let converted = RelayClientError.from(MteRelayError.mteEncodeError)
    ...
    func testFromMteDecodeErrorMapsToDecodingFailed() {
        let converted = RelayClientError.from(MteRelayError.mteDecodeError)
    ...
    func testFromNetworkErrorMapsToNetworkFailure() {
        let converted = RelayClientError.from(MteRelayError.networkError)
    ...
    func testFromStoreStateErrorMapsToStatePersistenceFailed() {
        let converted = RelayClientError.from(MteRelayError.storeStateError)
    ...
    func testFromMteRelayErrorNoneReturnsUnderlying() {
        // `.none` falls through to the default branch, yielding `.underlying`
        let converted = RelayClientError.from(MteRelayError.none)
        guard case .underlying = converted else {
            XCTFail("Expected .underlying for MteRelayError.none, got \(converted)")
            return
        }
    }
